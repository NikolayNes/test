...
describe('Non registered user: putting bags to the basket: ', () => {
    let mainPage = new MainPage();
    let bagsPage = new ManWomanShoesPage();
    ...
    it('First position in Bags Page', () => {
        mainPage.clickBags();
        let brandName = bagsPage.getBrandName(bagsPage.firstProduct);
        bagsPage.firstProduct.click();
    ...
    it('Third position in Bags Page', () => {
        mainPage.navigate();
        mainPage.clickBags();
        let brandName = bagsPage.getBrandName(bagsPage.thirdProduct);
        bagsPage.thirdProduct.click();
        detailsPage.buySelectedItem();
